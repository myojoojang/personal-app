      ...
      <div className='Header'>
        <div className='row mx-2 title'>
          ...
          <div className='semi-title d-flex text-right d-md-block col-md-6 my-auto'>
            <span>
              <a href="https://drive.google.com/file/d/1nVqOhvjshenXNoPro16z15bBGs-FTpgc/view?usp=sharing" target="_blank" rel="noopener noreferrer"><i className="fas fa-address-card"></i></a>
            </span>
